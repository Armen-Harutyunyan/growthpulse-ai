...
This project is built using an **AI-First Orchestration** approach. It contains a specialized instruction set designed for AI Agents (Cursor, Claude, GPT-4) to ensure consistency and speed.

- **`AGENTS.md`**: The master protocol for AI-human pair programming, defining operational modes (Architect, Vibe, Analyst).
- **`.agents/workflows/`**: Structural workflows for common engineering tasks (adding features, setting up A/B tests).
- **`.cursorrules`**: Strict technical enforcement for AI IDE assistants.
